...
namespace BombGame
{
    ...
    {
        public static readonly string BACKGROUND_URL = @"resource\sound\bg.wav";
        public static readonly string EXPLODE_URL = @"resource\sound\explode.wav";
        public static readonly string GET_URL = @"resource\sound\get.mav";
        ...
        public static void Play(string strFileName)
        {
            PlaySound(strFileName, UIntPtr.Zero,
               (uint)(SoundFlags.SND_FILENAME | SoundFlags.SND_ASYNC | SoundFlags.SND_NOWAIT | SoundFlags.SND_NOSTOP | SoundFlags.SND_LOOP));
        }

        public static void PlayOnce(string strFileName)
        {
            // PlaySound(strFileName, UIntPtr.Zero,
            //   (uint)(SoundFlags.SND_FILENAME | SoundFlags.SND_ASYNC | SoundFlags.SND_NOWAIT));
        }
